...
if($_SERVER['REQUEST_METHOD']=== 'POST'){
    ...
    $insert_product = $product -> insert_product($product_name);
    $cartegory_id = $_POST['cartegory_id'];
    $insert_product = $product -> insert_product($cartegory_id);
    $brand_id = $_POST['brand_id'];
    $insert_product = $product -> insert_product($brand_id);
    $product_price = $_POST['product_price'];
    $insert_product = $product -> insert_product($product_price);
    $product_price_new = $_POST['product_price_new'];
    $insert_product = $product -> insert_product($product_price_new);
    $product_desc = $_POST['product_desc'];
    $insert_product = $product -> insert_product($product_desc);
    $product_img = $_FILES['product_img']['name'];
    $insert_product = $product ->insert_product($product_img);
